...
public class TestCreateAnArchiveThatExists {
    ...
    public void test_Create_Archive_That_Exists(){
    	...
    	String duplicatedMessageError = objData.getErrorDuplicatedArchiveMessage();
		...
		Assert.assertTrue(objDashboardPage.getDuplicatedArchiveErrorToast().equals(duplicatedMessageError));
